...
public class Grid_5 extends SamuraiGrid {

    public Grid_5(int grid) {
        SIZE = grid;
    ...
    public void initCells() {
        createGrid(0, 0);
        createGrid(0, RULE_SPACE + SQUARE_SIZE);
        createGrid(RULE_SPACE * 2, RULE_SPACE * 2);
        createGrid(RULE_SPACE + SQUARE_SIZE, 0);
        createGrid(RULE_SPACE + SQUARE_SIZE, RULE_SPACE + SQUARE_SIZE);
    }
}
